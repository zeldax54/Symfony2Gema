...
class ProveedorRepository extends EntityRepository {
    ...
    public function filtrar(Request $request) {
        ...
        if ($request->request->get("searchPhrase") != null) {
            ...
            $qb->where($qb->expr()->like("P.proveedor", $qb->expr()->literal("%" . $search . "%")));
            $qb->orWhere($qb->expr()->like("P.email", $qb->expr()->literal("%" . $search . "%")));
            $qb->orWhere($qb->expr()->like("P.telefono", $qb->expr()->literal("%" . $search . "%")));
        }
