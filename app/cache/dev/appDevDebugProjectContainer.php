...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'gema.utiles' => 'getGema_UtilesService',
            ...
            'security.firewall.map.context.area_asegurada' => 'getSecurity_Firewall_Map_Context_AreaAseguradaService',
            ...
            'security.user.provider.concrete.unidos' => 'getSecurity_User_Provider_Concrete_UnidosService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/xampp/htdocs/gema/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/xampp/htdocs/gema/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'gemaBundle', 'C:/xampp/htdocs/gema/app/Resources/gemaBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'gemaBundle', 'C:\\xampp\\htdocs\\gema\\src\\GEMA\\gemaBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', 'C:/xampp/htdocs/gema/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/xampp/htdocs/gema/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'gema5', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_c14cc25d2dd35d1bc0d2a8faee97972583316bf5e962214c896576d2256f842c');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_c14cc25d2dd35d1bc0d2a8faee97972583316bf5e962214c896576d2256f842c');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_c14cc25d2dd35d1bc0d2a8faee97972583316bf5e962214c896576d2256f842c');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\xampp\\htdocs\\gema\\src\\GEMA\\gemaBundle\\Entity')), 'GEMA\\gemaBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('gemaBundle' => 'GEMA\\gemaBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('C:/xampp/htdocs/gema/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/xampp/htdocs/gema/app/Resources');
    }
    ...
    {
        return $this->services['fos_js_routing.extractor'] = new \FOS\JsRoutingBundle\Extractor\ExposedRoutesExtractor($this->get('router'), array(), 'C:/xampp/htdocs/gema/app/cache/dev', array('FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle', 'SecurityBundle' => 'Symfony\\Bundle\\SecurityBundle\\SecurityBundle', 'TwigBundle' => 'Symfony\\Bundle\\TwigBundle\\TwigBundle', 'MonologBundle' => 'Symfony\\Bundle\\MonologBundle\\MonologBundle', 'SwiftmailerBundle' => 'Symfony\\Bundle\\SwiftmailerBundle\\SwiftmailerBundle', 'AsseticBundle' => 'Symfony\\Bundle\\AsseticBundle\\AsseticBundle', 'DoctrineBundle' => 'Doctrine\\Bundle\\DoctrineBundle\\DoctrineBundle', 'SensioFrameworkExtraBundle' => 'Sensio\\Bundle\\FrameworkExtraBundle\\SensioFrameworkExtraBundle', 'gemaBundle' => 'GEMA\\gemaBundle\\gemaBundle', 'DoctrineFixturesBundle' => 'Doctrine\\Bundle\\FixturesBundle\\DoctrineFixturesBundle', 'FOSJsRoutingBundle' => 'FOS\\JsRoutingBundle\\FOSJsRoutingBundle', 'SlikDompdfBundle' => 'Slik\\DompdfBundle\\SlikDompdfBundle', 'ShtumiUsefulBundle' => 'Shtumi\\UsefulBundle\\ShtumiUsefulBundle', 'WebProfilerBundle' => 'Symfony\\Bundle\\WebProfilerBundle\\WebProfilerBundle', 'SensioDistributionBundle' => 'Sensio\\Bundle\\DistributionBundle\\SensioDistributionBundle', 'SensioGeneratorBundle' => 'Sensio\\Bundle\\GeneratorBundle\\SensioGeneratorBundle'));
    }
    ...
    /**
     * Gets the 'gema.utiles' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \GEMA\gemaBundle\Utiles\Utiles A GEMA\gemaBundle\Utiles\Utiles instance.
     */
    protected function getGema_UtilesService()
    {
        $this->services['gema.utiles'] = $instance = new \GEMA\gemaBundle\Utiles\Utiles($this->get('doctrine.orm.default_entity_manager'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/gema/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/xampp/htdocs/gema/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/xampp/htdocs/gema/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/xampp/htdocs/gema/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('GEMA\\gemaBundle\\Entity\\Usuario' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5)), 'Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$'), 'security.firewall.map.context.area_asegurada' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }

    /**
     * Gets the 'security.firewall.map.context.area_asegurada' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_Firewall_Map_Context_AreaAseguradaService()
    {
        $a = $this->get('security.context');
        $b = $this->get('security.user.provider.concrete.unidos');
        ...
        $h = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $b), 'GEMASESSION', 'area_asegurada', array('lifetime' => 1, 'name' => 'REMEMBERME', 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $c);

        $i = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $e, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($e, 'gema_login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'gema_logout'));
        $i->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $i->addHandler($h);

        $j = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($e, array('login_path' => 'gema_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $j->setProviderKey('area_asegurada');

        $k = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $e, 'area_asegurada', $j, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $e, array('login_path' => 'gema_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $c), array('check_path' => 'gema_login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $c, $d, NULL);
        $k->setRememberMeServices($h);

        return $this->services['security.firewall.map.context.area_asegurada'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b, 1 => $this->get('security.user.provider.concrete.in_memory'), 2 => $this->get('security.user.provider.concrete.base_datos')), 'area_asegurada', $c, $d), 2 => $i, 3 => $k, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $h, $g, $c, $d), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'area_asegurada', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'gema_login', false), NULL, NULL, $c));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_LoginService()
    {
        ...
        return $this->services['security.firewall.map.context.login'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.unidos'), 1 => $this->get('security.user.provider.concrete.in_memory'), 2 => $this->get('security.user.provider.concrete.base_datos')), 'login', $b, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '572a4a727ab3f', $b), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'login', NULL, NULL, NULL, $b));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/gema/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/xampp/htdocs/gema/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/gema/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/xampp/htdocs/gema/app', 'UTF-8');
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('area_asegurada', 'gema_logout', 'logout', '_csrf_token', NULL);
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/xampp/htdocs/gema/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/xampp/htdocs/gema/app', 'UTF-8'));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'gemaBundle:Form:theme.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'gemaBundle'), $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\gema\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\xampp\\htdocs\\gema\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:/xampp/htdocs/gema/app/Resources/TwigBundle/views', 'Twig');
        $instance->addPath('C:\\xampp\\htdocs\\gema\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\xampp\\htdocs\\gema\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\xampp\\htdocs\\gema\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\xampp\\htdocs\\gema\\src\\GEMA\\gemaBundle/Resources/views', 'gema');
        $instance->addPath('C:\\xampp\\htdocs\\gema\\vendor\\Shtumi\\UsefulBundle/Resources/views', 'ShtumiUseful');
        $instance->addPath('C:\\xampp\\htdocs\\gema\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\xampp\\htdocs\\gema\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/xampp/htdocs/gema/app/Resources/views');
        $instance->addPath('C:\\xampp\\htdocs\\gema\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'C:\\xampp\\htdocs\\gema\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
        $instance->addYamlMappings(array(0 => 'C:\\xampp\\htdocs\\gema\\src\\GEMA\\gemaBundle\\Resources\\config\\validation.yml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/gema/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/xampp/htdocs/gema/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/loggedcheck'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/rol/*'), array(0 => 'ROLE_ADMINISTRADOR'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/persona/*'), array(0 => 'ROLE_ADMINISTRADOR'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuario/*'), array(0 => 'ROLE_ADMINISTRADOR'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/traza/*'), array(0 => 'ROLE_ADMINISTRADOR'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/area/*'), array(0 => 'ROLE_ADMINISTRADOR'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/tipoactivo/*'), array(0 => 'ROLE_ADMINISTRADOR'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/herramienta/*'), array(0 => 'ROLE_ADMINISTRADOR', 1 => 'ROLE_MANTENIMIENTO'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/insumo/*'), array(0 => 'ROLE_ADMINISTRADOR', 1 => 'ROLE_MANTENIMIENTO'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/repuesto/*'), array(0 => 'ROLE_ADMINISTRADOR', 1 => 'ROLE_MANTENIMIENTO'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/tipoprioridad/*'), array(0 => 'ROLE_ADMINISTRADOR'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/proveedor/*'), array(0 => 'ROLE_ALMACENERO'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/factura/*'), array(0 => 'ROLE_ALMACENERO'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/activo/*'), array(0 => 'ROLE_ALMACENERO', 1 => 'ROLE_OPERACIONES'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/procedimiento/*'), array(0 => 'ROLE_MANTENIMIENTO'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/ordentrabajo/*'), array(0 => 'ROLE_MANTENIMIENTO'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/planmtto/*'), array(0 => 'ROLE_MANTENIMIENTO'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/accion/*'), array(0 => 'ROLE_MANTENIMIENTO'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('572a4a727ab3f'), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.unidos'), $a, 'area_asegurada', $this->get('security.encoder_factory'), true), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, 'GEMASESSION', 'area_asegurada')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMINISTRADOR' => array(0 => 'ROLE_USER'), 'ROLE_ALMACENERO' => array(0 => 'ROLE_USER'), 'ROLE_MANTENIMIENTO' => array(0 => 'ROLE_USER'), 'ROLE_OPERACIONES' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_MANTENIMIENTO', 2 => 'ROLE_ALMACENERO', 3 => 'ROLE_ADMINISTRADOR', 4 => 'ROLE_OPERACIONES', 5 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.base_datos'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'GEMA\\gemaBundle\\Entity\\Usuario', 'usuario', NULL);
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('almacenero', 'a', array(0 => 'ROLE_ALMACENERO')));
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('administrador', 'a', array(0 => 'ROLE_ADMINISTRADOR')));
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('mantenimiento', 'a', array(0 => 'ROLE_MANTENIMIENTO')));
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('admin', 'a', array(0 => 'ROLE_SUPER_ADMIN')));

        return $instance;
    }

    /**
     * Gets the 'security.user.provider.concrete.unidos' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_UnidosService()
    {
        return $this->services['security.user.provider.concrete.unidos'] = new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $this->get('security.user.provider.concrete.in_memory'), 1 => $this->get('security.user.provider.concrete.base_datos')));
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/gema/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/xampp/htdocs/gema/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp/htdocs/gema/app/cache/dev',
            'kernel.logs_dir' => 'C:/xampp/htdocs/gema/app/logs',
            'kernel.bundles' => array(
                ...
                'gemaBundle' => 'GEMA\\gemaBundle\\gemaBundle',
            ...
            'debug.container.dump' => 'C:/xampp/htdocs/gema/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/xampp/htdocs/gema/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/xampp/htdocs/gema/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/xampp/htdocs/gema/app/cache/dev/assetic/routing.yml',
            ...
            'security.role_hierarchy.roles' => array(
                ...
                'ROLE_ALMACENERO' => array(
                    0 => 'ROLE_USER',
                ),
                'ROLE_MANTENIMIENTO' => array(
                    0 => 'ROLE_USER',
                ),
                'ROLE_OPERACIONES' => array(
                    0 => 'ROLE_USER',
                ),
                'ROLE_SUPER_ADMIN' => array(
                    0 => 'ROLE_USER',
                    1 => 'ROLE_MANTENIMIENTO',
                    2 => 'ROLE_ALMACENERO',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'gemaBundle:Form:theme.html.twig',
            ),
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/gema/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/xampp/htdocs/gema/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/gema/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/xampp/htdocs/gema/app/../web',
            'assetic.write_to' => 'C:/xampp/htdocs/gema/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/gema/app/cache/dev/doctrine/orm/Proxies',
            ...
            'shtumi.dependent_filtered_entities' => array(
                'departamento_by_area' => array(
                    'class' => 'gemaBundle:Departamento',
                    'parent_property' => 'area',
                    'property' => 'title',
                    'role' => 'ROLE_USER',
                    'no_result_msg' => 'No hay departamentos definidos para esta Area',
