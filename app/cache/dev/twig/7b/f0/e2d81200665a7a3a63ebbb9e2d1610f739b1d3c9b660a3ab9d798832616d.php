...
/* gemaBundle:Activo:import.html.twig */
class __TwigTemplate_7bf0e2d81200665a7a3a63ebbb9e2d1610f739b1d3c9b660a3ab9d798832616d extends Twig_Template
{
...
";
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["e"]) {
                ...
                echo "</td>
                        <td>";
                // line 59
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["e"]) ? $context["e"] : $this->getContext($context, "e")), "factura"), "html", null, true);
                echo "</td>
                        <td>";
                // line 60
    ...
    <script>
        ...
        // line 180
        echo $this->env->getExtension('routing')->getPath("activo_new");
        echo "\\\"><i class=\\\"fa fa-plus-circle\\\"></i>Nuevo Expediente</a><a data-toggle=\\\"modal\\\" href=\\\"#graphModal\\\" id=\\\"modalTrigger\\\" class=\\\"m-r-10 btn-pdf\\\"><i class=\\\"fa fa-area-chart m-r-0\\\"></i></a><a href=\\\"";
        echo $this->env->getExtension('routing')->getPath("activo_reporte");
        echo "\\\" class=\\\"m-r-10 btn-pdf\\\"><i class=\\\"fa fa-file-pdf-o m-r-0\\\"></i></a><a href=\\\"";
        echo $this->env->getExtension('routing')->getPath("activo_reporte", array("type" => "excel"));
...
";
    ...
    {
        return "gemaBundle:Activo:import.html.twig";
    }
    ...
    {
        return array (  314 => 185,  308 => 181,  300 => 180,  249 => 133,  246 => 132,  222 => 110,  183 => 71,  176 => 66,  166 => 62,  162 => 61,  158 => 60,  154 => 59,  150 => 58,  146 => 57,  142 => 56,  138 => 55,  135 => 54,  131 => 53,  112 => 36,  104 => 31,  96 => 25,  93 => 24,  84 => 21,  80 => 19,  75 => 18,  66 => 15,  62 => 13,  58 => 12,  52 => 9,  49 => 8,  46 => 7,  40 => 4,  37 => 3,  31 => 2,);
    }
}
