 ...
 */
class Repuesto extends \GEMA\gemaBundle\Entity\Repuesto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GEMA\\gemaBundle\\Entity\\Repuesto' . "\0" . 'id', '' . "\0" . 'GEMA\\gemaBundle\\Entity\\Repuesto' . "\0" . 'nombre', '' . "\0" . 'GEMA\\gemaBundle\\Entity\\Repuesto' . "\0" . 'um', '' . "\0" . 'GEMA\\gemaBundle\\Entity\\Repuesto' . "\0" . 'costoUnitario', '' . "\0" . 'GEMA\\gemaBundle\\Entity\\Repuesto' . "\0" . 'otReps');
        }
