 ...
 */
class CentroCosto extends \GEMA\gemaBundle\Entity\CentroCosto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GEMA\\gemaBundle\\Entity\\CentroCosto' . "\0" . 'id', '' . "\0" . 'GEMA\\gemaBundle\\Entity\\CentroCosto' . "\0" . 'codigo', 'area', 'departamento', 'activos');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CentroCosto $proxy) {
