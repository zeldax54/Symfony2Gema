 ...
 */
class Rol extends \GEMA\gemaBundle\Entity\Rol implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GEMA\\gemaBundle\\Entity\\Rol' . "\0" . 'id', '' . "\0" . 'GEMA\\gemaBundle\\Entity\\Rol' . "\0" . 'nombre', '' . "\0" . 'GEMA\\gemaBundle\\Entity\\Rol' . "\0" . 'descripcion', '' . "\0" . 'GEMA\\gemaBundle\\Entity\\Rol' . "\0" . 'usuarios');
        }
